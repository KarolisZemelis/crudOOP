...
var Edit = /*#__PURE__*/function (_Request) {
  ...
  return _createClass(Edit, [{
    key: "listenToSubmitEdit",
    value: function listenToSubmitEdit(table, elementId) {
      var _this2 = this;
      this.editModal.querySelector('[data-type="submit"]').onclick = function (event) {
        var editObject = {};
        editObject.table = table;
        editObject.id = elementId;
        var inputs = _this2.editModal.querySelectorAll("[name]");
        inputs.forEach(function (input) {
          editObject[input.name] = input.value;
        });
        _this2.editToDb(editObject, table, _this2.MainObject);
    ...
    value: function listenToEdit(list) {
      ...
      list.addEventListener('click', function (event) {
        if (event.target.matches('[data-type="edit"]')) {
          ...
          _this3.listenToSubmitEdit(table, elementId);
        }
      });
    }
  }]);
  ...
  return _createClass(FormRecipe, [{
        ...
        container.ondrop = function (e) {
          ...
          try {
            ...
            if (cont === 'drop-container') {
              ...
              _this2.recipeToSave.ingredients.push(ingredientObj);
            }
          } catch (error) {
    ...
    value: function submitFormedRecipe() {
      ...
      submitBtn.addEventListener('click', function (_) {
        ...
        _this3.recipeDropContainer.innerHTML = '';
        _this3.ingredientDropContainer.innerHTML = '';
      });
    }
  }]);
}(_Request_js__WEBPACK_IMPORTED_MODULE_0__["default"]);
...
var Request = /*#__PURE__*/function () {
  ...
  return _createClass(Request, [{
    ...
    value: function getElementFromDbForm(id, MainObject, table, action) {
      return axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(this.url + '/' + 'formRecipe' + '/' + id, {
        params: {
          table: table
        }
      }).then(function (res) {
  ...
  return _createClass(ShowData, [{
    ...
    value: function renderFormData(response, table) {
      ...
      if (table === 'recipe') {
        ...
        removeButton.addEventListener('click', function () {
          ...
          var obj = _this3.MainObject.FormRecipe.recipeToSave;
          for (var key in obj) {
            if (obj[key] === responseData.id) {
              // Remove keys where value is false
              delete obj[key];
            }
          }
        });
        ...
        if (this.ingredientContainer.children.length > 0) {
          this.ingredientContainer.insertBefore(_itemClone2, this.ingredientContainer.children[0]);
        } else {
          this.ingredientContainer.appendChild(_itemClone2);
        }
    ...
    value: function renderSearchData(responseData) {
      ...
      searchInput.addEventListener('input', function (_) {
        _this4.recipeList.innerHTML = '';
        _this4.ingredientList.innerHTML = '';
        ...
        for (var _i2 = 0, _Object$entries2 = Object.entries(filteredData); _i2 < _Object$entries2.length; _i2++) {
          ...
          if (key === 'recipes') {
            var recipesArray = Array.from(value);
            recipesArray.forEach(function (recipe) {
              var itemClone = _this4.recipeTemplate.content.cloneNode(true);
              var li = itemClone.querySelector('li');
              li.setAttribute('data-itemid', "".concat(recipe.id));
              li.setAttribute('draggable', true);
              itemClone.querySelector('[data-recipe-name]').textContent = recipe.recipe_name.toUpperCase();
              itemClone.querySelector('[data-recipe-type]').textContent = recipe.type_name;
              itemClone.querySelector('[data-recipe-calories]').textContent = recipe.calories;
              _this4.recipeList.appendChild(itemClone);
            });
          } else {
            var ingredientsArray = Array.from(value);
            ingredientsArray.forEach(function (ingredient) {
              var itemClone = _this4.ingredientTemplate.content.cloneNode(true);
              var li = itemClone.querySelector('li');
              li.setAttribute('data-itemid', "".concat(ingredient.id));
              li.setAttribute('draggable', true);
              itemClone.querySelector('[data-ingredient-name]').textContent = ingredient.ingredient_name.toUpperCase();
              itemClone.querySelector('[data-ingredient-type]').textContent = ingredient.type_name;
              _this4.ingredientList.appendChild(itemClone);
            });
          }
        }
      });
...
switch (main === null || main === void 0 || (_main$dataset = main.dataset) === null || _main$dataset === void 0 ? void 0 : _main$dataset.page) {
  case 'recipes':
    new _Recipe__WEBPACK_IMPORTED_MODULE_0__["default"]('recipes');
    break;
}
